...
b.children("input[name=hourlyType][value=every]").is(":checked")?(f=0,h="*",b=b.children("select.cron-hourly-select").val(),1<b&&(h="0/"+b)):(f=b.children("select.cron-hourly-minute").val(),h=b.children("select.cron-hourly-hour").val());break;case "Daily":b=a.$el.find("div.cron-daily");b.children("input[name=dailyType][value=every]").is(":checked")?(b=b.children("select.cron-daily-select").val(),1<b&&(e="1/"+b)):(e="?",c="MON-FRI");break;case "Weekly":var b=a.$el.find("div.cron-weekly"),g=[];b.children("input[name=dayOfWeekMon]").is(":checked")&&
g.push("MON");b.children("input[name=dayOfWeekTue]").is(":checked")&&g.push("TUE");b.children("input[name=dayOfWeekWed]").is(":checked")&&g.push("WED");b.children("input[name=dayOfWeekThu]").is(":checked")&&g.push("THU");b.children("input[name=dayOfWeekFri]").is(":checked")&&g.push("FRI");b.children("input[name=dayOfWeekSat]").is(":checked")&&g.push("SAT");b.children("input[name=dayOfWeekSun]").is(":checked")&&g.push("SUN");c="*";e="?";7>g.length&&0<g.length&&(c=g.join(","));break;case "Monthly":b=
a.$el.find("div.cron-monthly");b.children("input[name=monthlyType][value=byDay]").is(":checked")?(d="*",g=b.children("select.cron-monthly-month").val(),e=b.children("select.cron-monthly-day").val(),c="?"):(c=b.children("select.cron-monthly-day-of-week").val()+"#"+b.children("select.cron-monthly-nth-day").val(),g=b.children("select.cron-monthly-month-by-week").val(),e="?");1<g&&(d="1/"+g);break;case "Yearly":b=a.$el.find("div.cron-yearly"),b.children("input[name=yearlyType][value=byDay]").is(":checked")?
(e=b.children("select.cron-yearly-day").val(),d=b.children("select.cron-yearly-month").val(),c="?"):(c=b.children("select.cron-yearly-day-of-week").val()+"#"+b.children("select.cron-yearly-nth-day").val(),d=b.children("select.cron-yearly-month-by-week").val(),e="?")}return[0,f,h,e,d,c,"*"].join(" ")};a.init()};e.cronBuilder.defaultOptions={selectorLabel:"Select period: "};e.fn.cronBuilder=function(d){return this.each(function(){new e.cronBuilder(this,d)})}})(jQuery);